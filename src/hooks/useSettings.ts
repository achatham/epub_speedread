...
export function useSettings(storageProvider: FirestoreStorage | null, onboardingCompleted: boolean) {
    ...
    }, [ttsSpeed, autoLandscape, theme, fontFamily, syncApiKey, geminiApiKey, deepgramApiKey, rsvpSettings, readerMode, onboardingCompleted]);
    ...
    }, [ttsSpeed, autoLandscape, theme, fontFamily, syncApiKey, geminiApiKey, deepgramApiKey, rsvpSettings, readerMode, storageProvider, onboardingCompleted]);
